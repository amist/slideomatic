#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe main.py -W cli_setup.py
...
main = Target(
    ...
    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="slideomatic", level="asInvoker")).encode("utf-8")),
...
shutil.copytree('impress', './dist/impress')
print("=) Done (=")
